...
<div class="space-y-6">
  ...
  <div class="space-y-2">
    ...
    <div class="relative">
      <input
        ...
        class="w-full rounded-lg border bg-white px-4 py-3 pr-10 text-sky-900 placeholder-sky-400 transition-colors focus:ring-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50
					{swimmerNameValid
  ...
  <div class="space-y-2">
    <span class="block text-sm font-medium text-sky-800"
      >Heat Sheet <span class="text-red-500">*</span></span
    >
